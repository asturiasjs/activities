...
Ejemplos de esto incluyen el uso de la cuenta oficial de correo electrónico, publicaciones a través de las redes sociales oficiales, o los eventos tanto presenciales como online organizados por la comunidad.

## Aplicación

Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento a través de [un DM en twitter a @asturias.js](https://twitter.com/asturiasjs). Todas las quejas serán evaluadas e investigadas de una manera puntual y justa.
